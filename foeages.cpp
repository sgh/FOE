...
void FoeAge::initialize()
{
	...
	_ageList.append( new FoeAge( "Bronzealder",         e_Bronze,         QColor( 0xB3, 0x88, 0x12 ) ));
	_ageList.append( new FoeAge( "Jernalder",           e_Iron,           QColor( 0x98, 0x45, 0x20 ) ));
	_ageList.append( new FoeAge( "Tidlig middelalder",  e_EarlyMiddleAge, QColor( 0x50, 0x81, 0x44 ) ));
	_ageList.append( new FoeAge( "Højmiddelalder",      e_HighMiddleAge,  QColor( 0x2F, 0x8E, 0x8E ) ));
	_ageList.append( new FoeAge( "Senmiddelalder",      e_LateMiddleAge,  QColor( 0x7E, 0x41, 0x86 ) ));
